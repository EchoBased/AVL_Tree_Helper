...
class AVLTree:
    ...
    def insert(self,value):
        if self.root==None:
            ...
            print(str(value) + " is added to the tree")
        else:
    ...
    def _insert(self,value,cur_node):
        if value<cur_node.value:
            ...
            print(str(value) + " is already in the tree.")
            return False
    ...
    def findMax(self):
        ...
        if node is None:
            ...
            while node.right_child != None:
                node = node.right_child     
            print("Max Value is: " + str(node.value))
    ...
    def findMin(self):
        ...
        if node is None:
            ...
            while node.left_child != None:
                node = node.left_child
            print("Min Value is: " + str(node.value))
...
def nav(x):
    if x == '0':
        ...
        inVal = input("input a key: ")
        avlTree.insert(int(inVal)) 
        ...
        inVal = input("input a key: ")
        outVal = (avlTree.search(int(inVal)))

        if outVal is True:
            print(inVal + " exists in the tree.")
        else:
            print(inVal + " does not exist in the tree.")
        ...
        if outVal is True:
            adder = avlTree.find(int(inVal))
            hVal = avlTree.get_height(adder) - 1
            print(inVal + "'s height is "+ str(hVal))
        else:
            print(inVal + " does not exist in the tree.")
        ...
        if outVal is True:
            dVal = (avlTree.depth(int(inVal)))
            print(inVal + "'s depth "+ str(dVal))
        else:
            print(inVal + " does not exist in the tree.")
